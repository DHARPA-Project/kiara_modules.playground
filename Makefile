...
init: clean ## initialize a development environment (to be run in virtualenv)
	...
	pip install --pre --extra-index-url https://pypi.fury.io/dharpa/ --extra-index-url https://gitlab.com/api/v4/projects/25344049/packages/pypi/simple -U 'kiara_modules.language_processing'
	pip install --pre --extra-index-url https://pypi.fury.io/dharpa/ --extra-index-url https://gitlab.com/api/v4/projects/25344049/packages/pypi/simple -U 'kiara_modules.network_analysis'
#	pre-commit install
